...
export class TransactionHistoryRepository {
  ...
  async getTxHistoryBySafeAddress(
    ...
    const result: unknown[] = await this.repos.query(
      `
      SELECT AT.Id as AuraTxId, MT.Id as MultisigTxId, AT.TxHash as TxHash, MT.TypeUrl as TypeUrl, AT.FromAddress as FromAddress, AT.Amount as AuraTxAmount, AT.RewardAmount as AuraTxRewardAmount, MT.Amount as MultisigTxAmount, AT.Code as Status, MT.Sequence as Sequence, MT.Denom as Denom, AT.CreatedAt as CreatedAt, AT.UpdatedAt as UpdatedAt, AT.Timestamp as Timestamp 
