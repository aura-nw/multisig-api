  ...
  implements ITransactionRepository
{
  ...
  async getAuraTx(
    ...
    const result: any[] = await this.repos.query(
      `
      SELECT AT.Id as AuraTxId, MT.Id as MultisigTxId, AT.TxHash as TxHash, MT.TypeUrl as TypeUrl, AT.FromAddress as FromAddress, AT.Amount as AuraTxAmount, AT.RewardAmount as AuraTxRewardAmount, MT.Amount as MultisigTxAmount, AT.Code as Status, AT.CreatedAt as CreatedAt, AT.UpdatedAt as UpdatedAt FROM AuraTx AT
